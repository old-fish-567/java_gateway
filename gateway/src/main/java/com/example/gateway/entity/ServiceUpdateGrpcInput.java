...
public class ServiceUpdateGrpcInput implements Serializable {
    ...
    public ServiceUpdateGrpcInput() {
    }

    public ServiceUpdateGrpcInput(int id, String serviceName, String serviceDesc, int port, String headerTransfor, int openAuth, String blackList, String whiteList, String whiteHostName, int clientIpFlowLimit, int serviceFlowLimit, int roundType, String ipList, String weightList, String forbidList) {
        this.id = id;
